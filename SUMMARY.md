...
* [Python](python/python_quick_start.md)
...
## Storage
* [Clickhouse](clickhouse/clickhouse_quick_start.md)
* [Zookeeper](zookeeper/zookeeper_quick_start.md)
* [Hadoop](hadoop/hadoop_quick_start.md)
    * [在Ubuntu_Centos上部署Hadoop](hadoop/hadoop_deploy_linux.md)
    * [在Mac OS上部署Hadoop](hadoop/hadoop_deploy_mac.md)
* [Hive](hive/hive_quick_start.md)
    * [Join解析](hive/hive_join.md)
    * [分析函数](hive/hive_analysis_function.md)
    * [SQL优化](hive/hive_optimize.md)
    * [Hive划重点](hive/hive_important.md)

## Transfer
* [Kafka](kafka/kafka_quick_start.md)
* [Flume](flume/flume_quick_start.md)

## Analysis Framework
* [大数据架构](analysis/framework_model.md)
* [数据仓库](analysis/data_warehouse_mart.md)
* [常用数据分析模型](analysis/analysis_model.md)
* [数据指标体系](analysis/data_indicator_system.md)
* [数据湖](analysis/data_lake.md)
